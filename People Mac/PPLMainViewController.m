...
@interface PPLMainViewController ()
...
@property (strong, nonatomic) PPLUserController *userController;
@property (strong, nonatomic) PPLUser *highlightedUser;

@end

@interface PPLMainViewController () <NSTableViewDataSource, NSTableViewDelegate>

@end

@implementation PPLMainViewController

- (instancetype)init {
    self = [self initWithNibName:@"PPLMainView" bundle:[NSBundle mainBundle]];
    if (self) {
        _userController = [[PPLUserController alloc] init];
    }
    return self;
}
